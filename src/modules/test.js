...
export const makeTestHtml = (test, idx) => `<div class="test">
              <span onclick="removeTest(${idx})" class="close">&cross;</span>
              <div class="input-group mt-1 mb-3">
                <span class="input-group-text">Окружность</span>
              ...
              <div class="d-flex align-items-center justify-content-between mt-3">
                ...
                <div class="d-flex align-items-center justify-content-between">
                   <button onclick="calculate(${idx})" class="btn btn-dark d-flex align-items-center justify-content-center me-4">
                  ...
                  <button onclick="draw(document.querySelector('canvas').getContext('2d'), ${idx})" class="btn btn-outline-secondary d-flex align-items-center justify-content-center">
